...
struct LinePrinter {
  ...
  // Allows checking if the console is locked to refrain from printing status updates
  // (which would be buffered and not displayed).
  bool GetConsoleLocked() { return console_locked_; }
